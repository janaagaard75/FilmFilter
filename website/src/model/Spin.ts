...
class Spin {
  ...
  private animations = {} // Animation rules keyed by their name
   ...
   */
  private ins(parent: any /* child1, child2, ...*/) {
   ...
   */
  private addAnimation(alpha: any, trail: any, i: number, lines: Array<any>) {
  ...
  public lines(el, o) {
    ...
    for (; i < o.lines; i++) {
      ...
      if (o.shadow) this.ins(seg, css(fill("#000", "0 0 4px #000"), { top: "2px" }))
      this.ins(el, this.ins(seg, fill(getColor(o.color, i), "0 0 1px rgba(0,0,0,.1)")))
    }
    return el
  }
